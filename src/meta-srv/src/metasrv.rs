...
use crate::selector::{RegionFailoverDestPeerSelector, Selector, SelectorType};
...
pub type RegionFailoverDestPeerSelectorRef = Arc<
    dyn RegionFailoverDestPeerSelector<Context = SelectorContext, Output = Vec<(RegionId, Peer)>>,
>;
